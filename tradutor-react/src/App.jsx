    ...
    <div className='min-h-screen bg-background flex flex-col'>
      ...
      <header className='bg-white shadow-sm'>
        <div className='max-w-5xl mx-auto px-4 py-3 flex items-center'>
          <h1 className='text-headerColor text-2xl font-bold'>Tradutor-React</h1>
        </div>
      </header>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2'>
            ...
            <div className='p-4 relative bg-secondaryBackground border-l border-gray-200'>
              <div className='absolute inset-0 flex items-center justify-center'>
                ...
                {isLoading ? (<div className='animate-spin rounded-full h-8 w-8 border-t-2 border-blue-500'></div>) : (<p className=' text-lg text-textColor'>{translatedText}</p>)}
      ...
      <footer className='bg-white border-t border-gray-200 mt-auto'>
        <div className='max-w-5xl mx-auto px-4 py-3 text-sm text-headerColor'>
           &copy; {new Date().getFullYear()} Tradutor Luis Henrique
           </div>
      </footer>
